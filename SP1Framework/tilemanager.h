...
bool collision(char array[40][101], int playerycoord, int playerxcoord);
char** getarray(void);
//bool touchmonster(char array[15][87], int playerycoord, int playerxcoord);
bool touchkey(char array[40][101], int playerycoord, int playerxcoord);
bool touchend(char array[40][101], int playerycoord, int playerxcoord);
